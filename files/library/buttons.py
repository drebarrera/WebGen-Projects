...
### CLASSIC BUTTON ###
class button:
    def __init__(self, button_type, text, link_url=None, click_f=None, primary_color='black', accent_color='white', width='auto', padding='1.25vh', radius='sharp', shadow=False, inverse=False, underline=False):
